...
const SignUp = () => {
    ...
    const saveUser = (name, email) => {
        ...
        fetch('https://doctors-portal-server-beta-bice.vercel.app/users', {
            method: 'POST',
            headers: {
    ...
    //     fetch(`https://doctors-portal-server-beta-bice.vercel.app/jwt?email=${email}`)
    //     .then(res => res.json())
    //     .then(data => {
    //         if(data.accessToken){
