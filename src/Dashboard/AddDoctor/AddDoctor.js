...
const AddDoctor = () => {
  ...
  const { data: specialities = [], isLoading } = useQuery({
    queryKey: ["speciality"],
    queryFn: async () => {
      const res = await fetch("https://doctors-portal-server-beta-bice.vercel.app/appointmentSpecialty");
  ...
  const handleAddDoctor = (data) => {
    ...
    .then(imgData => {
      if(imgData.success){
        ...
        fetch('https://doctors-portal-server-beta-bice.vercel.app/doctors', {
          method: 'POST',
          headers:{
